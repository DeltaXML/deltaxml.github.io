define(["require", "exports"], function (require, exports) {
    ...
    exports.FunctionData = exports.XSLTnamespaces = void 0;
    var XSLTnamespaces;
    (function (XSLTnamespaces) {
        XSLTnamespaces[XSLTnamespaces["NotDefined"] = 0] = "NotDefined";
        XSLTnamespaces[XSLTnamespaces["Array"] = 1] = "Array";
        XSLTnamespaces[XSLTnamespaces["ExpathArchive"] = 2] = "ExpathArchive";
        XSLTnamespaces[XSLTnamespaces["ExpathBinary"] = 3] = "ExpathBinary";
        XSLTnamespaces[XSLTnamespaces["ExpathFile"] = 4] = "ExpathFile";
        XSLTnamespaces[XSLTnamespaces["Map"] = 5] = "Map";
        XSLTnamespaces[XSLTnamespaces["Math"] = 6] = "Math";
        XSLTnamespaces[XSLTnamespaces["Saxon"] = 7] = "Saxon";
        XSLTnamespaces[XSLTnamespaces["SQL"] = 8] = "SQL";
        XSLTnamespaces[XSLTnamespaces["XMLSchema"] = 9] = "XMLSchema";
        XSLTnamespaces[XSLTnamespaces["XPath"] = 10] = "XPath";
        XSLTnamespaces[XSLTnamespaces["XSLT"] = 11] = "XSLT";
        XSLTnamespaces[XSLTnamespaces["IXSL"] = 12] = "IXSL";
    })(XSLTnamespaces = exports.XSLTnamespaces || (exports.XSLTnamespaces = {}));
    var FunctionData = /** @class */ (function () {
        function FunctionData() {
        }
        FunctionData.unionSimpleTypes = function () {
            var baseSimpleTypes = FunctionData.schema.map(function (t) { return 'xs:' + t.substring(0, t.length - 2); });
        ...
        FunctionData.simpleTypes = FunctionData.unionSimpleTypes();
        FunctionData.namespaces = new Map([
